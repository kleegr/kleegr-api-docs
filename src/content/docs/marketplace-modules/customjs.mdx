---
title: "CustomJS"
description: "CustomJS — Kleegr developer documentation"
---

## Wrapper functions

Kleegr provides functions to render contextual data & some utilities that can help developers customize experience for the user.
